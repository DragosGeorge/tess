...
//			CPythonNetworkStream& netStream = CPythonNetworkStream::Instance();
//			netStream.RecvPreloadEntitiesPacket();
//#endif
		}
		else
		{
...
#endif
	// __CollectCollisionShadowReceiver(v3Player, v3Light); // 2019.08.21.owsap - memory leak
#ifdef __PERFORMANCE_CHECKER__
...
void CMapOutdoor::__UpdateGarvage(DWORD dwEraseInterval)
{
	const DWORD dwTerrainEraseInterval = dwEraseInterval > 0 ? dwEraseInterval : 1000 * 60;
